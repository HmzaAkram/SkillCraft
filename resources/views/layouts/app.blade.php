...
<body>
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-white shadow-sm fixed-top">
            <div class="container">
                ...
                <div class="d-flex align-items-center gap-2">
                    <a href="#" class="btn btn-sm btn-danger">Register</a>
                    <a href="#" class="btn btn-sm btn-outline-danger">Login</a>
                </div>
            </div>
        </nav>
    </header>
    ...
    <section class="hero">
        <div class="hero-content">
            ...
            <p>Transform your potential into expertise with personalized learning paths, adaptive exercises, and intelligent feedback systems designed just for you.</p>
    ...
    <section class="features" id="features">
        <div class="container">
            <div class="section-header">
                ...
                <p>Discover how our AI-driven platform revolutionizes skill development</p>
            </div>
            <div class="features-grid">
                <div class="feature-card">
                    ...
                    <p>Personalized curricula that adapt to your learning style, pace, and goals for optimal skill development.</p>
                </div>
                <div class="feature-card">
                    <div class="feature-icon">
                    ...
                    <p>Monitor your advancement with detailed analytics and insights into your learning journey.</p>
                </div>
                <div class="feature-card">
                    <div class="feature-icon">
                    ...
                    <p>Connect with mentors and peers in your field for guidance, support, and collaboration.</p>
                </div>
            </div>
        </div>
    </section>
